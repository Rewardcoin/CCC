...
{
    if(Height > pindexBest->nHeight) { return "000002240390bdb4701c04918cd6880f4294df46ba3e5cbbdc324044d537767c"; }
    if(Height < 0) { return "000002240390bdb4701c04918cd6880f4294df46ba3e5cbbdc324044d537767c"; }
    int desiredheight;
...
{    
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " CCC");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " CCC");
    }
}
