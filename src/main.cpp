...
unsigned int nStakeTargetSpacing = 300;			// 300 seconds block spacing

int64 nChainStartTime = 1455440400;
...
const string strMessageMagic = "CCCoin Signed Message:\n";
...
static const int CUTOFF_HEIGHT = 1000000;	// irrelevant
...
if (nHeight<2 && nHeight>0)
        {
                nSubsidy = 27000000 * COIN;
        }
if (nHeight<1000000 && nHeight>2)
        {
                nSubsidy = 1 * COIN;
        }
...
const int YEARLY_BLOCKCOUNT = 105120;	// 365 * 24 * 12 * 1 ( 1 blocks every 5 min)
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    int64 nRewardCoinYear;
    nRewardCoinYear = MAX_RC_PROOF_OF_STAKE;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in CCCoin
    bool fStrictPayToScriptHash = true; // Always active in CCCoin
...
bool CBlock::AcceptBlock()
{
	...
	//CCC will be pure PoW until modifier_switch_block
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CCCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        nStakeMinAge = 10000 * 10000; // test net min age disabled
        nStakeMaxAge = 10000 * 10000; // test net max age disabled
		nModifierInterval = 30; // test modifier interval is 0.5 minutes
        nCoinbaseMaturity = 120; // test maturity is 5 blocks
        nStakeTargetSpacing = 30; // test block spacing is 1 minutes
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CCCoin";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1455440400; // epochtimestamp 1455440400
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1856073;
        ...
        assert(block.hashMerkleRoot == uint256("0x8329d4c77f4aa16d007a348602e58370ac5123659b5b23c6e904b2de124cfea2")); //merkleroot of CCC
...
unsigned char pchMessageStart[4] = { 0x7e, 0x7a, 0xe7, 0xff };
